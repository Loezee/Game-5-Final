...
{
    //so the texts can use things in the GameManager
    ...
    void OnMouseDown()
    {
        //connected to GameManager's "public void ToggleSelect(SwitchText clicked)"
        //tells GameManager which text is selected
        //"this" is which text is selected
    ...
    public void SetSelected(bool selected)
    {
        ...
        //when selected, make it yellow, but if it's not selected, then make it white
        if (isSelected)
        {
